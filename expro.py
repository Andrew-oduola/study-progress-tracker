...
class MainPage(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent, bg='light blue', width=670, height=520)
        self.controller = controller

        self.main_frame = tk.Frame(self, width=670, height=500, bg='light green')
        self.main_frame.place(x=0, y=0)

        self.label = tk.Label(self.main_frame, text=f"{days_left} days left to EXAM", font=FONT_1,  bg='light green', fg='white')
        self.label.grid(row=0, column=0, columnspan=3, pady=10)

        self.von = 3

        self.gen_progressbar = ttk.Progressbar(self.main_frame, maximum=100, value=settings['general-progress'], length=600)
        self.gen_progressbar.grid(row=1, column=0, columnspan=3, pady=(0, 5))

        self.mts_frame = tk.Frame(self.main_frame, width=20, height=10)
        self.mts_frame.grid(row=2, column=0, padx=(10, 0))
        self.mts_label = tk.Label(self.mts_frame, text="MTS 101", font=FONT_2)
        self.mts_label.pack(pady=10)
        self.mts_progressbar = ttk.Progressbar(self.mts_frame, maximum=100, value=settings['mts-progress'], length=200)
        self.mts_progressbar.pack(padx=5)
        self.mts_button = tk.Button(self.mts_frame, text='Progress', command=lambda: controller.show_frame('MTS'))
        self.mts_button.pack(pady=10)

        self.phy101_frame = tk.Frame(self.main_frame, width=20, height=10)
        ...
        self.phy101_progressbar = ttk.Progressbar(self.phy101_frame, maximum=100, value=settings['phy-progress'], length=200)
        self.phy101_progressbar.pack(padx=5)
        self.phy101_button = tk.Button(self.phy101_frame, text='Progress', command=lambda: controller.show_frame('PHY'))
        self.phy101_button.pack(pady=10)

        self.mee101_frame = tk.Frame(self.main_frame, width=20, height=10)
        ...
        self.mee101_progressbar = ttk.Progressbar(self.mee101_frame, maximum=100, value=settings['mee-progress'], length=200)
        self.mee101_progressbar.pack(padx=5)
        self.mee101_button = tk.Button(self.mee101_frame, text='Progress', command=lambda: controller.show_frame('MEE'))
        self.mee101_button.pack(pady=10)

        
        self.bio101_frame = tk.Frame(self.main_frame, width=20, height=10)
        ...
        self.bio101_progressbar = ttk.Progressbar(self.bio101_frame, maximum=100, value=settings['bio-progress'], length=200)
        self.bio101_progressbar.pack(padx=5)
        self.bio101_button = tk.Button(self.bio101_frame, text='Progress', command=lambda: controller.show_frame('BIO'))
        self.bio101_button.pack(pady=10)

        self.gns101_frame = tk.Frame(self.main_frame, width=20, height=10)
        ...
        self.gns101_progressbar = ttk.Progressbar(self.gns101_frame, maximum=100, value=settings['gns1-progress'], length=200)
        self.gns101_progressbar.pack(padx=5)
        self.gns101_button = tk.Button(self.gns101_frame, text='Progress', command=lambda: controller.show_frame('GNS1'))
        self.gns101_button.pack(pady=10)

        self.gns103_frame = tk.Frame(self.main_frame, width=20, height=10)
        ...
        self.gns103_progressbar = ttk.Progressbar(self.gns103_frame, maximum=100, value=settings['gns3-progress'], length=200)
        self.gns103_progressbar.pack(padx=5)
        self.gns103_button = tk.Button(self.gns103_frame, text='Progress', command=lambda: controller.show_frame('GNS3'))
        self.gns103_button.pack(pady=10)

        self.che101_frame = tk.Frame(self.main_frame, width=20, height=10)
        ...
        self.che101_progressbar = ttk.Progressbar(self.che101_frame, maximum=100, value=settings['che-progress'], length=200)
        self.che101_progressbar.pack(padx=5)
        self.che101_button = tk.Button(self.che101_frame, text='Progress', command=lambda: controller.show_frame('CHE'))
...
class MTS(tk.Frame):
    def __init__(self, parent, controller):
        ...
        mts_progress = ttk.Progressbar(main_frame, value=settings['mts-progress'], maximum=100, length=450)
        mts_progress.pack()
        ...
        a_pro = ttk.Progressbar(prog_frame, value=settings['mts']['sec-a'], length=200, maximum=100)
        ...
        b_pro = ttk.Progressbar(prog_frame, value=settings['mts']['sec-b'], length=200, maximum=100)
        ...
        c_pro = ttk.Progressbar(prog_frame, value=settings['mts']['sec-c'], length=200, maximum=100)
        ...
        d_pro = ttk.Progressbar(prog_frame, value=settings['mts']['sec-d'], length=200, maximum=100)
        ...
        e_pro = ttk.Progressbar(prog_frame, value=settings['mts']['sec-e'], length=200, maximum=100)
        ...
        f_pro = ttk.Progressbar(prog_frame, value=settings['mts']['sec-f'], length=200, maximum=100)
        ...
        g_pro = ttk.Progressbar(prog_frame, value=settings['mts']['sec-g'], length=200, maximum=100)
...
class PHY(tk.Frame):
    def __init__(self, parent, controller):
        ...
        phy_progress = ttk.Progressbar(main_frame, value=settings['phy-progress'], maximum=100, length=450)
        phy_progress.pack()
        ...
        um_pro = ttk.Progressbar(prog_frame, value=settings['phy']['um'], length=200, maximum=100)
        ...
        vs_pro = ttk.Progressbar(prog_frame, value=settings['phy']['vs'], length=200, maximum=100)
        ...
        ki_pro = ttk.Progressbar(prog_frame, value=settings['phy']['ki'], length=200, maximum=100)
        ...
        wp_pro = ttk.Progressbar(prog_frame, value=settings['phy']['wp'], length=200, maximum=100)
        ...
        pr_pro = ttk.Progressbar(prog_frame, value=settings['phy']['pr'], length=200, maximum=100)
        ...
        mw_pro = ttk.Progressbar(prog_frame, value=settings['phy']['mw'], length=200, maximum=100)
        ...
        nm_pro = ttk.Progressbar(prog_frame, value=settings['phy']['nw'], length=200, maximum=100)
        ...
        sd_pro = ttk.Progressbar(prog_frame, value=settings['phy']['sd'], length=200, maximum=100)
        ...
        rm_pro = ttk.Progressbar(prog_frame, value=settings['phy']['rm'], length=200, maximum=100)
...
class MEE(tk.Frame):
    def __init__(self, parent, controller):
        ...
        mee_progress = ttk.Progressbar(main_frame, value=settings['mee-progress'], maximum=100, length=450)
        mee_progress.pack()
        ...
        ge_pro = ttk.Progressbar(prog_frame, value=settings['mee']['ge'], length=200, maximum=100)
        ...
        po_pro = ttk.Progressbar(prog_frame, value=settings['mee']['po'], length=200, maximum=100)
        ...
        ta_pro = ttk.Progressbar(prog_frame, value=settings['mee']['ta'], length=200, maximum=100)
        ...
        lo_pro = ttk.Progressbar(prog_frame, value=settings['mee']['lo'], length=200, maximum=100)
        ...
        pp_pro = ttk.Progressbar(prog_frame, value=settings['mee']['pp'], length=200, maximum=100)
        ...
        op_pro = ttk.Progressbar(prog_frame, value=settings['mee']['op'], length=200, maximum=100)
        ...
        fs_pro = ttk.Progressbar(prog_frame, value=settings['mee']['fs'], length=200, maximum=100)
...
class BIO(tk.Frame):
    def __init__(self, parent, controller):
        ...
        bio_progress = ttk.Progressbar(main_frame, value=settings['bio-progress'], maximum=100, length=450)
        bio_progress.pack()
        ...
        bi_pro = ttk.Progressbar(prog_frame, value=settings['bio']['bi'], length=200, maximum=100)
        ...
        ec_pro = ttk.Progressbar(prog_frame, value=settings['bio']['ec'], length=200, maximum=100)
        ...
        ce_pro = ttk.Progressbar(prog_frame, value=settings['bio']['ce'], length=200, maximum=100)
        ...
        re_pro = ttk.Progressbar(prog_frame, value=settings['bio']['re'], length=200, maximum=100)
        ...
        va_pro = ttk.Progressbar(prog_frame, value=settings['bio']['va'], length=200, maximum=100)
        ...
        bp_pro = ttk.Progressbar(prog_frame, value=settings['bio']['bp'], length=200, maximum=100)
        ...
        af_pro = ttk.Progressbar(prog_frame, value=settings['bio']['af'], length=200, maximum=100)
        ...
        vf_pro = ttk.Progressbar(prog_frame, value=settings['bio']['vf'], length=200, maximum=100)
...
class GNS1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        gns101_progress = ttk.Progressbar(main_frame, value=settings['gns1-progress'], maximum=100, length=450)
        ...
        tm_pro = ttk.Progressbar(prog_frame, value=settings['gns1']['tm'], length=200, maximum=100)
        ...
        ss_pro = ttk.Progressbar(prog_frame, value=settings['gns1']['ss'], length=200, maximum=100)
        ...
        wf_pro = ttk.Progressbar(prog_frame, value=settings['gns1']['wf'], length=200, maximum=100)
        ...
        ps_pro = ttk.Progressbar(prog_frame, value=settings['gns1']['ps'], length=200, maximum=100)
        ...
        nt_pro = ttk.Progressbar(prog_frame, value=settings['gns1']['nt'], length=200, maximum=100)
...
class GNS3(tk.Frame):
    def __init__(self, parent, controller):
        ...
        gns103_progress = ttk.Progressbar(main_frame, value=settings['gns3-progress'], maximum=100, length=450)
        ...
        c12_pro = ttk.Progressbar(prog_frame, value=settings['gns3']['c12'], length=200, maximum=100)
        ...
        c34_pro = ttk.Progressbar(prog_frame, value=settings['gns3']['c34'], length=200, maximum=100)
        ...
        c56_pro = ttk.Progressbar(prog_frame, value=settings['gns3']['c56'], length=200, maximum=100)
        ...
        c78_pro = ttk.Progressbar(prog_frame, value=settings['gns3']['c78'], length=200, maximum=100)
...
class CHE(tk.Frame):
    def __init__(self, parent, controller):
        ...
        che_progress = ttk.Progressbar(main_frame, value=settings['che-progress'], maximum=100, length=450)
        che_progress.pack()
        ...
        at_pro = ttk.Progressbar(prog_frame, value=settings['che']['at'], length=200, maximum=100)
        ...
        ea_pro = ttk.Progressbar(prog_frame, value=settings['che']['ea'], length=200, maximum=100)
        ...
        ce_label.grid(row=2, column=0)
        ce_pro = ttk.Progressbar(prog_frame, value=settings['che']['ce'], length=200, maximum=100)
        ce_pro.grid(row=2, column=1, padx=10)
        ce_entry = tk.Entry(prog_frame, width=5)
        ce_entry.grid(row=2, column=2)
        ...
        ck_pro = ttk.Progressbar(prog_frame, value=settings['che']['ck'], length=200, maximum=100)
        ...
        tc_pro = ttk.Progressbar(prog_frame, value=settings['che']['tc'], length=200, maximum=100)
        ...
        ec_pro = ttk.Progressbar(prog_frame, value=settings['che']['ec'], length=200, maximum=100)
        ...
        ra_pro = ttk.Progressbar(prog_frame, value=settings['che']['ra'], length=200, maximum=100)
        ...
        sl_pro = ttk.Progressbar(prog_frame, value=settings['che']['sl'], length=200, maximum=100)
